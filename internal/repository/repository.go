...
type TagRepository interface {
	...
	DeleteTag(ctx context.Context, id model.Uuid) error
}

type ProjectRepository interface {
	GetProject(ctx context.Context, id model.Uuid) (*model.Project, error)
	ListProjects(ctx context.Context) ([]*model.Project, error)
	CreateProject(ctx context.Context, project *model.Project) (*model.Project, error)
	UpdateProject(ctx context.Context, project *model.Project) (*model.Project, error)
	DeleteProject(ctx context.Context, id model.Uuid) error
}

type TimeSpanRepository interface {
	GetTimeSpan(ctx context.Context, id model.Uuid) (*model.TimeSpan, error)
	...
	DeleteTimeSpan(ctx context.Context, id model.Uuid) error
}
