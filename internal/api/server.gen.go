...
func (siw *ServerInterfaceWrapper) AuthCallback(w http.ResponseWriter, r *http.Request) {
...

	{
		...
		if cookie, err = r.Cookie("inundated_login"); err == nil {
			...
			err = runtime.BindStyledParameterWithOptions("simple", "inundated_login", cookie.Value, &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationCookie, Explode: true, Required: false, Type: "string", Format: ""})
			if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteTimespan(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "timespanId", chi.URLParam(r, "timespanId"), &timespanId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid"})
	if err != nil {
