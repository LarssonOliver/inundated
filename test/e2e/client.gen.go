...
func NewAuthCallbackRequest(server string, params *AuthCallbackParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.InundatedLogin != nil {
			var cookieParam0 string

			cookieParam0, err = runtime.StyleParamWithOptions("simple", true, "inundated_login", *params.InundatedLogin, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationCookie, Type: "string", Format: ""})
			if err != nil {
				return nil, err
			}

			cookie0 := &http.Cookie{
				Name:  "inundated_login",
				Value: cookieParam0,
			}
...
func NewDeleteTimespanRequest(server string, timespanId TimespanIdPath) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "timespanId", timespanId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: "uuid"})
	if err != nil {
		return nil, err
	}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ListTimespansResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r CreateTimespanResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r DeleteTimespanResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetTimespanResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r UpdateTimespanResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
